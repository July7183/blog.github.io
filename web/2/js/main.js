...
$('#set-clock1').click(function () {
    if ($('#set-clock1').is(':checked')) {
        sPrimaryClock = 'on';
        tPrimaryClock();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sPrimaryClock on']);
    } else {
        sPrimaryClock = 'off';
        tPrimaryClock();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sPrimaryClock off']);
    }
});
$('#set-seconds').click(function () {
    if ($('#set-seconds').is(':checked')) {
        sSeconds = 'on';
        tSeconds();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sSeconds on']);
    } else {
        sSeconds = 'off';
        tSeconds();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sSeconds off']);
    }
});
$('#set-meridiem').click(function () {
    if ($('#set-meridiem').is(':checked')) {
        sMeridiem = 'on';
        tMeridiem();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sMeridiem on']);
    } else {
        sMeridiem = 'off';
        tMeridiem();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sMeridiem off']);
    }
});
$('#set-military').click(function () {
    if ($('#set-military').is(':checked')) {
        sMilitary = 'on';
        tMilitary();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sMilitary on']);
    } else {
        sMilitary = 'off';
        tMilitary();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sMilitary off']);
    }
});
$('#set-delimiter').click(function () {
    if ($('#set-delimiter').is(':checked')) {
        sDelimiter = 'on';
        tDelimiter();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sDelimiter on']);
    } else {
        sDelimiter = 'off';
        tDelimiter();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sDelimiter off']);
    }
});
$('#set-blinking').click(function () {
    if ($('#set-blinking').is(':checked')) {
        sBlinking = 'on';
        tBlinking();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sBlinking on']);
    } else {
        sBlinking = 'off';
        tBlinking();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sBlinking off']);
    }
});
$('#set-brackets').click(function () {
    if ($('#set-brackets').is(':checked')) {
        sBrackets = 'on';
        tBrackets();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sBrackets on']);
    } else {
        sBrackets = 'off';
        tBrackets();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sBrackets off']);
    }
});
$('#set-time2').click(function () {
    if ($('#set-time2').is(':checked')) {
        s2ndClock = 'on';
        t2ndClock();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 's2ndClock on']);
    } else {
        s2ndClock = 'off';
        t2ndClock();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 's2ndClock off']);
    }
});
$('#set-time2-zone').change(function () {
    s2ndClockTimezone = $(this).val();
    t2ndClockTimezone(s2ndClockTimezone);
    _gaq.push(['_trackEvent', 'Settings', 'Select', 's2ndClockTimezone']);
});
$('#set-time2-label').change(function () {
    s2ndClockLabel = $(this).val();
    t2ndClockLabel(s2ndClockLabel);
    _gaq.push(['_trackEvent', 'Settings', 'Type', 's2ndClockLabel']);
});
$('#set-time3').click(function () {
    if ($('#set-time3').is(':checked')) {
        s3rdClock = 'on';
        t3rdClock();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 's3rdClock on']);
    } else {
        s3rdClock = 'off';
        t3rdClock();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 's3rdClock off']);
    }
});
$('#set-time3-zone').change(function () {
    s3rdClockTimezone = $(this).val();
    t3rdClockTimezone(s3rdClockTimezone);
    _gaq.push(['_trackEvent', 'Settings', 'Select', 's3rdClockTimezone']);
});
$('#set-time3-label').change(function () {
    s3rdClockLabel = $(this).val();
    t3rdClockLabel(s3rdClockLabel);
    _gaq.push(['_trackEvent', 'Settings', 'Type', 's3rdClockLabel']);
});
$('#set-time4').click(function () {
    if ($('#set-time4').is(':checked')) {
        s4thClock = 'on';
        t4thClock();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 's4thClock on']);
    } else {
        s4thClock = 'off';
        t4thClock();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 's4thClock off']);
    }
});
$('#set-time4-zone').change(function () {
    s4thClockTimezone = $(this).val();
    t4thClockTimezone(s4thClockTimezone);
    _gaq.push(['_trackEvent', 'Settings', 'Select', 's4thClockTimezone']);
});
$('#set-time4-label').change(function () {
    s4thClockLabel = $(this).val();
    t4thClockLabel(s4thClockLabel);
    _gaq.push(['_trackEvent', 'Settings', 'Type', 's4thClockLabel']);
});
$('#set-date').click(function () {
    if ($('#set-date').is(':checked')) {
        sDate = 'on';
        tDate();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sDate on']);
    } else {
        sDate = 'off';
        tDate();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sDate off']);
    }
});
$('#set-day').click(function () {
    if ($('#set-day').is(':checked')) {
        sDay = 'on';
        tDay();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sDay on']);
    } else {
        sDay = 'off';
        tDay();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sDay off']);
    }
});
$('#set-year').click(function () {
    if ($('#set-year').is(':checked')) {
        sYear = 'on';
        tYear();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sYear on']);
    } else {
        sYear = 'off';
        tYear();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sYear off']);
    }
});
$('#set-shortdate').click(function () {
    if ($('#set-shortdate').is(':checked')) {
        sShortDate = 'on';
        tShortDate();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sShortDate on']);
    } else {
        sShortDate = 'off';
        tShortDate();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sShortDate off']);
    }
});
...
$('#set-link1').click(function () {
    if ($('#set-link1').is(':checked')) {
        s1stLink = 'on';
        t1stLink();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 's1stLink on']);
    } else {
        s1stLink = 'off';
        t1stLink();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 's1stLink off']);
    }
});
$('#set-link1-url').change(function () {
    s1stLinkUrl = $(this).val();
    t1stLinkUrl(s1stLinkUrl);
    _gaq.push(['_trackEvent', 'Settings', 'Type', 's1stLinkUrl']);
});
$('#set-link1-label').change(function () {
    s1stLinkLabel = $(this).val();
    t1stLinkLabel(s1stLinkLabel);
    _gaq.push(['_trackEvent', 'Settings', 'Type', 's1stLinkLabel']);
});
$('#set-link2').click(function () {
    if ($('#set-link2').is(':checked')) {
        s2ndLink = 'on';
        t2ndLink();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 's2ndLink on']);
    } else {
        s2ndLink = 'off';
        t2ndLink();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 's2ndLink off']);
    }
});
$('#set-link2-url').change(function () {
    s2ndLinkUrl = $(this).val();
    t2ndLinkUrl(s2ndLinkUrl);
    _gaq.push(['_trackEvent', 'Settings', 'Type', 's2ndLinkUrl']);
});
$('#set-link2-label').change(function () {
    s2ndLinkLabel = $(this).val();
    t2ndLinkLabel(s2ndLinkLabel);
    _gaq.push(['_trackEvent', 'Settings', 'Type', 's2ndLinkLabel']);
});
$('#set-link3').click(function () {
    if ($('#set-link3').is(':checked')) {
        s3rdLink = 'on';
        t3rdLink();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 's3rdLink on']);
    } else {
        s3rdLink = 'off';
        t3rdLink();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 's3rdLink off']);
    }
});
$('#set-link3-url').change(function () {
    s3rdLinkUrl = $(this).val();
    t3rdLinkUrl(s3rdLinkUrl);
    _gaq.push(['_trackEvent', 'Settings', 'Type', 's3rdLinkUrl']);
});
$('#set-link3-label').change(function () {
    s3rdLinkLabel = $(this).val();
    t3rdLinkLabel(s3rdLinkLabel);
    _gaq.push(['_trackEvent', 'Settings', 'Type', 's3rdLinkLabel']);
});
$('#set-link4').click(function () {
    if ($('#set-link4').is(':checked')) {
        s4thLink = 'on';
        t4thLink();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 's4thLink on']);
    } else {
        s4thLink = 'off';
        t4thLink();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 's4thLink off']);
    }
});
$('#set-link4-url').change(function () {
    s4thLinkUrl = $(this).val();
    t4thLinkUrl(s4thLinkUrl);
    _gaq.push(['_trackEvent', 'Settings', 'Type', 's4thLinkUrl']);
});
$('#set-link4-label').change(function () {
    s4thLinkLabel = $(this).val();
    t4thLinkLabel(s4thLinkLabel);
    _gaq.push(['_trackEvent', 'Settings', 'Type', 's4thLinkLabel']);
});
$('#set-link5').click(function () {
    if ($('#set-link5').is(':checked')) {
        s5thLink = 'on';
        t5thLink();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 's5thLink on']);
    } else {
        s5thLink = 'off';
        t5thLink();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 's5thLink off']);
    }
});
$('#set-link5-url').change(function () {
    s5thLinkUrl = $(this).val();
    t5thLinkUrl(s5thLinkUrl);
    _gaq.push(['_trackEvent', 'Settings', 'Type', 's5thLinkUrl']);
});
$('#set-link5-label').change(function () {
    s5thLinkLabel = $(this).val();
    t5thLinkLabel(s5thLinkLabel);
    _gaq.push(['_trackEvent', 'Settings', 'Type', 's5thLinkLabel']);
});
$('#set-link6').click(function () {
    if ($('#set-link6').is(':checked')) {
        s6thLink = 'on';
        t6thLink();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 's6thLink on']);
    } else {
        s6thLink = 'off';
        t6thLink();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 's6thLink off']);
    }
});
$('#set-link6-url').change(function () {
    s6thLinkUrl = $(this).val();
    t6thLinkUrl(s6thLinkUrl);
    _gaq.push(['_trackEvent', 'Settings', 'Type', 's6thLinkUrl']);
});
$('#set-link6-label').change(function () {
    s6thLinkLabel = $(this).val();
    t6thLinkLabel(s6thLinkLabel);
    _gaq.push(['_trackEvent', 'Settings', 'Type', 's6thLinkLabel']);
});
$('input[name="set-tab-title"]').click(function () {
    sTabTitle = $(this).val();
    tTabTitle();
    _gaq.push(['_trackEvent', 'Settings', 'Radio', 'sTabTitle ' + sTabTitle]);
});
$('#set-tab-custom-message').change(function () {
    sTabTitleCustomMessage = $(this).val();
    tTabTitleCustomMessage(sTabTitleCustomMessage);
    _gaq.push(['_trackEvent', 'Settings', 'Type', 'sTabTitleCustomMessage']);
});
$('#set-message').click(function () {
    if ($('#set-message').is(':checked')) {
        sCustomMessage = 'on';
        tCustomMessage();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sCustomMessage on']);
    } else {
        sCustomMessage = 'off';
        tCustomMessage();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sCustomMessage off']);
    }
});
$('#set-message-text').change(function () {
    sCustomMessageText = $(this).val();
    tCustomMessageText(sCustomMessageText);
    _gaq.push(['_trackEvent', 'Settings', 'Type', 'sCustomMessageText']);
});
$('#set-search').click(function () {
    if ($('#set-search').is(':checked')) {
        sSearch = 'on';
        tSearch();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sSearch on']);
    } else {
        sSearch = 'off';
        tSearch();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sSearch off']);
    }
});
...
$('#set-animation').click(function () {
    if ($('#set-animation').is(':checked')) {
        sAnimation = 'on';
        tAnimation();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sAnimation on']);
    } else {
        sAnimation = 'off';
        tAnimation();
        _gaq.push(['_trackEvent', 'Settings', 'Toggle', 'sAnimation off']);
    }
});
...
$('#theme01').click(function () {
    sBackground = '#FFFFFF';
    sForeground = '#000000';
    document.getElementById('set-background').jscolor.fromString(sBackground);
    document.getElementById('set-foreground').jscolor.fromString(sForeground);
    tBackground(sBackground);
    tForeground(sForeground);
});
...
function updateTime() {
    if (sPrimaryClock == 'on') {
        ...
        $('.clock1 .hour').each(function (index) {
        ...
        $('.clock1 .minute').each(function (index) {
            var characters = $(this).text().split("");
            $this = $(this);
            $this.empty();
            $.each(characters, function (i, el) {
        ...
        if (sSeconds == "on") {
            ...
            $('.clock1 .seconds').each(function (index) {
                var characters = $(this).text().split("");
                $this = $(this);
                $this.empty();
                $.each(characters, function (i, el) {
